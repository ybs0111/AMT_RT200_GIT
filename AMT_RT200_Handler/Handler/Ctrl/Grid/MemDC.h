...
class CMEMGridDC : public CDC
{
public:

    // constructor sets up the memory DC
    CMEMGridDC(CDC* pDC) : CDC()
    {
        ASSERT(pDC != NULL);
    ...
    CMEMGridDC* operator->() {return this;}
        
    // Allow usage as a pointer
    operator CMEMGridDC*() {return this;}

private:
    CBitmap  m_bitmap;      // Offscreen bitmap
    CBitmap* m_pOldBitmap;  // bitmap originally found in CMEMGridDC
