...
//                        DEFAULT_PITCH|FF_SWISS, "Tahoma");
	m_Font.CreateFontW(24, 0, 0, 0, FW_NORMAL, FALSE, FALSE, FALSE, ANSI_CHARSET,OUT_DEFAULT_PRECIS, CLIP_DEFAULT_PRECIS, DEFAULT_QUALITY, VARIABLE_PITCH | FF_SWISS, _T("Tahoma")); 
